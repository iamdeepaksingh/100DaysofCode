...
class Cafe(db.Model):
    ...
    def to_dict(self):
        ...
        # Altenatively use Dictionary Comprehension to do the same thing.
...
# Test using http://127.0.0.1:5000/search?loc=Peckham
@app.route("/search")
...
def delete_cafe(cafe_id):
    ...
    if api_key == "cgvhk86bilf5e4vgdffghfh442rex5yr66":
        cafe = db.session.query(Cafe).get(cafe_id)
        if cafe:
